...
locale_emulator::LEB locale_emulator::create_leb()
{
	LEB leb{};
	...
	HKEY hTimeZone;
	if (RegOpenKey(
		HKEY_LOCAL_MACHINE, L"SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Time Zones\\Tokyo Standard Time",
